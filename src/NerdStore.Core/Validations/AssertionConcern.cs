...
public class AssertionConcern
{
    ...
    public static void ValidateIfSmallerEqualsMinimum(long value, long min, string message)
    {
        if (value <= min)
            throw new DomainException();
    }

    public static void ValidateIfSmallerEqualsMinimum(double value, double min, string message)
    {
        if (value <= min)
            throw new DomainException();
    }

    public static void ValidateIfSmallerEqualsMinimum(decimal value, decimal min, string message)
    {
        if (value <= min)
            throw new DomainException();
    }

    public static void ValidateIfSmallerEqualsMinimum(int value, int min, string message)
    {
        if (value <= min)
            throw new DomainException();
    }
